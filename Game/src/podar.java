...
class podar {
    ...
    public void start()
    {
    	timerUpdate.setDelay(10); // Установка временной задержки для таймера
        timerUpdate.start(); // Запуск таймера
        y = 250; // Отступ сверху в пикселях
        x = 350; // Отступ слева в пикселях, получаем случайным образом от 0 до 700
        act = true; // 
    }
    ...
    public void vniz()
    {
       ...
       {
          y+=1; // Увеличение отступа сверху на 6 пикселей
       }
