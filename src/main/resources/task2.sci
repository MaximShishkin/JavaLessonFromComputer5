...
plot2d(xv,yv,2)
xgrid();
xtitle("", "Number of agents, υ", "Ratio of lost voice requests, π_v");
legend("Required ratio of lost voice requests, 5%","Ratio of lost voice requests, π_v",1);
y_axes = gca();
...
plot2d(xf,yf,2)
xgrid();
xtitle("", "Number of agents, υ", "Ratio of lost file requests, π_f");
legend("Required ratio of lost voice requests, 5%","Ratio of lost file requests, π_f",1);
y_axes = gca();
y_axes.children.children(1).thickness = 2;
y_axes.children.children(2).thickness = 2;
